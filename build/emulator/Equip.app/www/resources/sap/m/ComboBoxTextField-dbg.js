...
sap.ui.define(['jquery.sap.global', './InputBase', './ComboBoxTextFieldRenderer', './library'],
	function(jQuery, InputBase, ComboBoxTextFieldRenderer, library) {
		"use strict";
		...
		ComboBoxTextField.prototype.updateValueStateClasses = function(sValueState, sOldValueState) {
			...
			var mValueState = sap.ui.core.ValueState,
				CSS_CLASS = ComboBoxTextFieldRenderer.CSS_CLASS_COMBOBOXTEXTFIELD,
				$DomRef = this.$();
